...
export default async function RegistroPage({ params }: Props) {
  ...
  const campos = [{ icon: Hash, label: "ID", value: registro.id }, { icon: GraduationCap, label: "Carrera", value: registro.carrera }, { icon: BookOpen, label: "Módulo", value: registro.modulo }, { icon: User, label: "Profesor", value: registro.profesor }, { icon: Building2, label: "Salón", value: registro.salon }, { icon: Clock, label: "Horario", value: registro.horarioClase }]
